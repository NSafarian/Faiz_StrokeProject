...
# 1) Visualize the expression levels of select markers in all clusters
...
#2) Visualize the expression levels of select markers in the two clusters of interest
## 2.1) Subset Seurat object 
seu.cluster6and7 <- subset(seu.combined, subset=new_clusters %in%c("6","7"))

## 2.2) Heatmap expression levels in the single-cell data
